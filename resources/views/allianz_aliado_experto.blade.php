        ...
        <div class="row">
          <div class="checkbox-salud checkbox-group col-sm-12 text-center">
              <div class="custom-control custom-checkbox input-group-prepend">
                ...
                <div class="glyphicon glyphicon-info-sign" data-target="#carouselExampleIndicators" data-slide-to="0"></div>
              </div>
          </div>
          <div class="checkbox-vida checkbox-group col-sm-12 text-center">
              <div class="custom-control custom-checkbox input-group-prepend">
                ...
                <div class="glyphicon glyphicon-info-sign" data-target="#carouselExampleIndicators" data-slide-to="1"></div>
              </div>
          </div>
          <div class="checkbox-hogar checkbox-group col-sm-12 text-center">
              <div class="custom-control custom-checkbox input-group-prepend">
                ...
                <div class="glyphicon glyphicon-info-sign" data-target="#carouselExampleIndicators" data-slide-to="2"></div>
              </div>
          </div>
          <div class="checkbox-autos checkbox-group col-sm-12 text-center">
              <div class="custom-control custom-checkbox input-group-prepend">
                ...
                <div class="glyphicon glyphicon-info-sign" data-target="#carouselExampleIndicators" data-slide-to="3"></div>
              </div>
          </div>
        </div>
